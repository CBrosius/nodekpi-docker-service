...
CA_API_SERVER_PLAIN_PORT=8080
CA_OSCP_SERVER_URL=127.0.0.1
CA_OSCP_SERVER_PORT=2560

ROOT_PASSPHRASE=${PASSPHRASE:?'Root passphrase needed'}
...
INTERMEDIATE_PASSPHRASE=${PASSPHRASE:?'Intermediate passphrase needed'}
INTERMEDIATE_CA_COMMON_NAME="Private Intermediate CA"

OCSP_PASSPHRASE=${PASSPHRASE:?'OCSP_PASSPHRASE passphrase needed'}
